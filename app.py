...
st.title("BasketXpert DashBoard")

st.markdown("""<style>.css-15zrgzn svg{display:none}     display: none;</style>""", unsafe_allow_html=True)
...
if tab == "BasketXpert":
    st.title("Welcome to BasketXpert's data analysis!")
    ...
    #    st.subheader("Apriori Algorithm")
       ...
       with open("style.css") as f:
        ...
        st.markdown("""<p id="title-1z2x">Item Recommender</p>""", unsafe_allow_html=True)
